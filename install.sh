...
echo ""
echo -e "1. ${GREEN}Upload transcripts to aisessions.dev:${NC}"
echo -e "   ${YELLOW}aisessions login${NC}"
echo -e "   ${YELLOW}aisessions upload${NC}"
echo ""
echo -e "2. ${GREEN}Use as MCP server (access transcripts across AI coding tools):${NC}"
echo -e "   See: ${ORANGE}https://github.com/yoavf/ai-sessions-mcp#setup${NC}"
echo ""
